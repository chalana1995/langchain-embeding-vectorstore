ASTRA_DB_SECURE_BUNDLE_PATH="" #astra database vectore stroe file path
ASTRA_DB_APPLICATION_TOKEN="" #astra database aplication token
ASTRA_DB_CLIENT_ID="" #astra database client id
ASTRA_DB_CLIENT_SECRET="" #astra databse client secret
...
myEmbrdding= OpenAIEmbeddings(openai_api_key=OPENAI_API_KEY)

myCassandraVStore = Cassandra(
    embedding=myEmbrdding,
